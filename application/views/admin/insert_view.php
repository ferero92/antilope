  <section class="container my-border">
    <div class="my-form">
      ...
      <form class="form-horizontal" action="<?php echo base_url('Admin/insert/' . $this->session->flashdata('action_user_type')) ?>" method="post">
        ...
        <div class="form-group tipo1">
          ...
          <div class="col-sm-10">
            <select class="form-control" name="planta" required>
              <?php echo $this->help->select('Plantas', 0); ?>
            </select>
          </div>
        </div>
        ...
        <input type="number" name="habitacion" class="tipo2 hidden" required>
        <input type="number" name="numero_cama" class="tipo2 hidden" required>
        <div class="form-group tipo2">
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <button class="btn my-btn-insert" type="submit">Insertar</button>
          </div>
        </div>
      </form>
    </div>
