...
<head>
  ...
  <script src="<?php echo base_url('scripts/Chart.min.js'); ?>" charset="utf-8"></script>
  ...
  <link rel="stylesheet" href="<?php echo base_url('plugins/choosebed/style.css'); ?>">
  <script src="<?php echo base_url('plugins/choosebed/code.js'); ?>" charset="utf-8"></script>
